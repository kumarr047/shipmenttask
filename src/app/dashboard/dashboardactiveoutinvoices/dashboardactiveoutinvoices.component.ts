...
@Component({
  selector: 'app-dashboardactiveoutinvoices',
  templateUrl: './dashboardactiveoutinvoices.component.html',
  styleUrls: ['./dashboardactiveoutinvoices.component.css']
})
export class DashboardactiveoutinvoicesComponent implements OnInit {
