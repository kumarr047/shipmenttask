...
@Component({
  selector: 'app-dashboardactivebookings',
  templateUrl: './dashboardactivebookings.component.html',
  styleUrls: ['./dashboardactivebookings.component.css']
})
export class DashboardactivebookingsComponent implements OnInit {
